...
def plot_CvProfiles(um_data, ifs_data, misc_data, ra2t_data, obs_data, month_flag, missing_files, um_out_dir, doy, obs, obs_switch): #, lon, lat):
    ...
    if month_flag == -1:
        fileout = 'FIGS/Obs-' + obs_switch + 'grid-QF30_RA2M_IFS_CASIM-100_RA2T_Cv_226-257DOY_blueNaNs_newColours.svg'
    plt.savefig(fileout)
    plt.show()
...
def plot_lwcProfiles(um_data, ifs_data, misc_data, ra2t_data, obs_data, month_flag, missing_files, um_out_dir, doy, obs_switch): #, lon, lat):
    ...
    if month_flag == -1:
        fileout = 'FIGS/Obs-' + obs_switch + 'grid-QF30-adiabatic-incNoLWP_IFS_RA2M_CASIM-100_RA2T_LWC_MTThresholding_226-257DOY_blueNaNs_newColours.png'
    # plt.savefig(fileout)
    plt.show()
...
def plot_iwcProfiles(um_data, ifs_data, misc_data, ra2t_data, obs_data, month_flag, missing_files, um_out_dir, doy, obs_switch): #, lon, lat):
    ...
    um_data['model_iwc_filtered'][ind1] = np.nan
    ifs_data['model_snow_iwc_filtered'][ind3] = np.nan
    misc_data['model_iwc_filtered'][ind2] = np.nan
    ra2t_data['model_iwc_filtered'][ind4] = np.nan
    ...
    if month_flag == -1:
        fileout = 'FIGS/Obs-' + obs_switch + 'grid_UM_IFS_CASIM-100_IWC-TWCgt1e-6kgm3_226-257DOY_blueNaNs_newColours.svg'
    plt.savefig(fileout)
    plt.show()
...
def plot_twcProfiles(um_data, ifs_data, misc_data, ra2t_data, obs_data, month_flag, missing_files, um_out_dir, doy, obs_switch): #, lon, lat):
    ...
    if month_flag == -1:
        fileout = 'FIGS/Obs-' + obs_switch + 'grid-QF30_gt1e-6kgm3_RA2M_IFS_CASIM-100_RA2T_TWC_226-257DOY_blueNaNs_LWC-IWCthreshFirst_newColours.svg'
    # plt.savefig(fileout)
    plt.show()
