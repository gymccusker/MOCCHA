...
def plot_CvProfiles(um_data, ifs_data, misc_data, ra2t_data, obs_data, month_flag, missing_files, um_out_dir, doy, obs, obs_switch): #, lon, lat):
    ...
    plt.subplots_adjust(top = 0.95, bottom = 0.1, right = 0.95, left = 0.15,
    ...
    if month_flag == -1:
        fileout = 'FIGS/Obs-' + obs_switch + 'grid-QF10_RA2M_IFS_CASIM-100_RA2T_Cv_226-257DOY_blueNaNs_newColours.svg'
    plt.savefig(fileout)
    plt.show()
