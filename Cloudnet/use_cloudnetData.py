...
def plot_LWP(um_data, ifs_data, misc_data, obs_data, month_flag, missing_files, um_out_dir, doy): #, lon, lat):
    ...
    plt.plot(um_data['time'][::2],um_data['model_lwp'][::2]*1e3,
        'o', color = 'steelblue', markeredgecolor = 'midnightblue', label = 'UM_RA2M')
    plt.plot(ifs_data['time'][::2],ifs_data['model_lwp'][::2]*1e3,
        '^', color = 'darkorange', markeredgecolor = 'saddlebrown', label = 'ECMWF_IFS')
    plt.plot(misc_data['time'][::2],misc_data['model_lwp'][::2]*1e3,
        's', color = 'forestgreen', markeredgecolor = 'darkgreen', label = 'UM_CASIM-100')
