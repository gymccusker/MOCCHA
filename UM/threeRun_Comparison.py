...
def plot_Radiosondes(data1, data2, data3, month_flag, missing_files, out_dir1, out_dir2, out_dir4, obs, doy, label1, label2, label3):
    ...
    plt.pcolor(obs['sondes']['doy'][drift[0]],obs['sondes']['gpsaltitude'][:,drift[0][0]],obs['sondes']['temperature'][:,drift[0]],
        vmin = -25, vmax = 5)
    plt.ylim([0,4000])
    ...
    plt.pcolor(data3['time_hrly'][::6],np.nanmean(data3['height'],0),np.transpose(data3['temp_hrly'][::6,:])-273.15,
        vmin = -25, vmax = 5)
    plt.ylim([0,4000])
    plt.xlim([doy[0],doy[-1]])
    plt.colorbar()
    ...
    plt.pcolor(data1['time_hrly'][::6],data1['height'],np.transpose(data1['temp_hrly'][::6,:])-273.15,
        vmin = -25, vmax = 5)
    plt.ylim([0,4000])
    plt.xlim([doy[0],doy[-1]])
    plt.colorbar()
    ...
    plt.pcolor(data2['time_hrly'][::6],data2['height'],np.transpose(data2['temp_hrly'][::6,:])-273.15,
        vmin = -25, vmax = 5)
    plt.ylim([0,4000])
    plt.xlim([doy[0],doy[-1]])
    plt.colorbar()
    ...
    plt.pcolor(obs['sondes']['doy'][drift[0]],data1['height'][iUM[0][3:]],np.transpose(obs['sondes']['temp_hrly_UM'][drift[0],:]),
        vmin = -25, vmax = 5)
    plt.ylim([0,4000])
    plt.xlim([doy[0],doy[-1]])
    plt.colorbar()
    ...
    plt.pcolor(data1['time_hrly'][::6],data1['height'][iUM[0][3:]],np.transpose(data1['temp_hrly'][::6,iUM[0][3:]])-273.15,
        vmin = -25, vmax = 5)
    plt.ylim([0,4000])
    plt.xlim([doy[0],doy[-1]])
    plt.colorbar()
    ...
    plt.pcolor(data2['time_hrly'][::6],data2['height'][iUM[0][3:]],np.transpose(data2['temp_hrly'][::6,iUM[0][3:]])-273.15,
        vmin = -25, vmax = 5)
    plt.ylim([0,4000])
    plt.xlim([doy[0],doy[-1]])
    plt.colorbar()
    ...
    plt.pcolor(data3['time_hrly'][::6],data1['height'][iUM[0][3:]],np.transpose(data3['temp_hrly_UM'][::6])-273.15,
        vmin = -25, vmax = 5, cmap=mpl_cm.RdBu_r)
    plt.ylim([0,4000])
    plt.xlim([doy[0],doy[-1]])
    plt.colorbar()
    ...
    plt.colorbar()
    # plt.ylabel('Z [m]')
    plt.title('Sondes(INTP) - ' + label1 + ', T[degC]')
    ...
    plt.xlabel('Day of year')
    # plt.ylabel('Z [m]')
    plt.title('Sondes(INTP) - ' + label2 + ', T[degC]')
