...
def plot_RadiosondesThetaVL(data1, data2, data3, month_flag, missing_files, out_dir1, out_dir2, out_dir4, obs, doy, label1, label2, label3):
    ...
    # data3['theta'], data3['thetaE'] = calcThetaVL(data3['temperature'], data3['pressure'], data3['q'], data3['time'], np.squeeze(data3['height'][0,:]))
    ...
    # print ('')
    #
    # fileout = '../FIGS/comparisons/ThetaVLProfiles_REGRID_10km_sondes-calculated_metum_ifs_casim-100.png'
    # plt.savefig(fileout, dpi = 300)
    # plt.show()
...
def main():
    ...
    figure = plot_RadiosondesThetaVL(data1, data2, data3, month_flag, missing_files, out_dir1, out_dir2, out_dir4, obs, doy, label1, label2, label3)
