...
def reGrid_ICData(ic_data, data_lam, obs, date, var):
...
def plot_CASIM_NdropTimeseries(data1, data2):
    ...
    # plt.plot(np.nanmedian(data2['mean_cloud_fraction'],0),data2['height'], '--', color = 'darkorange', linewidth = 3)
    # plt.plot(np.nanmedian(data1['cloud_fraction'],0),data1['height'], '--', color = 'mediumseagreen', linewidth = 3)
    plt.xlabel('C$_{V}$')
    plt.legend()
    ...
    data1['qnliq'][data1['qnliq'] <= 0.0] = np.nan
    ...
    plt.plot(np.nanmean(data2['mean_qliq'],0),data2['height'], color = 'darkorange', linewidth = 3, label = 'UM_CASIM-100_Swath')
    plt.plot(np.nanmean(data1['qnliq'],0)*1e3,data1['height'], color = 'mediumseagreen', linewidth = 3, label = 'UM_CASIM-100_Point')
    # plt.plot(np.nanmedian(data2['mean_qliq'],0)*1e3,data2['height'], '--', color = 'darkorange', linewidth = 3, label = 'UM_CASIM-100_Swath')
    # plt.plot(np.nanmedian(data1['qliq'],0)*1e3,data1['height'], '--', color = 'mediumseagreen', linewidth = 3, label = 'UM_CASIM-100_Point')
    ...
    data1['qnice'][data1['qnice'] <= 0.0] = np.nan
    ...
    plt.plot(np.nanmean(data1['qnice'],0)*1e3,data1['height'], color = 'mediumseagreen', linewidth = 3, label = 'UM_CASIM-100_Point')
    # plt.plot(np.nanmedian(data2['mean_qice'],0)*1e3,data2['height'], '--', color = 'darkorange', linewidth = 3, label = 'UM_CASIM-100_Swath')
    # plt.plot(np.nanmedian(data1['qice'],0)*1e3,data1['height'], '--', color = 'mediumseagreen', linewidth = 3, label = 'UM_CASIM-100_Point')
    ...
    plt.subplot(231)
    ax = plt.gca()
    ax.fill_betweenx(data2['height'],np.nanmedian(np.squeeze(data2['mean_cloud_fraction'][melt,:]),0) - np.nanstd(np.squeeze(data2['mean_cloud_fraction'][melt,:]),0),
        np.nanmedian(np.squeeze(data2['mean_cloud_fraction'][melt,:]),0) + np.nanstd(np.squeeze(data2['mean_cloud_fraction'][melt,:]),0), color = 'orange', alpha = 0.15)
    ax.fill_betweenx(data1['height'],np.nanmedian(np.squeeze(data1['cloud_fraction'][melt,:]),0) - np.nanstd(np.squeeze(data1['cloud_fraction'][melt,:]),0),
        np.nanmedian(np.squeeze(data1['cloud_fraction'][melt,:]),0) + np.nanstd(np.squeeze(data1['cloud_fraction'][melt,:]),0), color = 'mediumaquamarine', alpha = 0.15)
    ...
    plt.plot(np.nanmedian(np.squeeze(data2['mean_cloud_fraction'][melt,:]),0),data2['height'], color = 'darkorange', linewidth = 3, label = 'Swath')
    plt.plot(np.nanmedian(np.squeeze(data1['cloud_fraction'][melt,:]),0),data1['height'], color = 'mediumseagreen', linewidth = 3, label = 'Point')
    # plt.xlabel('C$_{V}$')
    plt.legend()
    # ax.xaxis.set_label_position('top')
    plt.ylabel('Z [km]')
    ...
    plt.subplot(232)
    ax = plt.gca()
    ax.fill_betweenx(data2['height'],np.nanmedian(np.squeeze(data2['mean_qliq'][melt,:]),0)*1e3 - np.nanstd(np.squeeze(data2['mean_qliq'][melt,:]),0)*1e3,
        np.nanmedian(np.squeeze(data2['mean_qliq'][melt,:]),0)*1e3 + np.nanstd(np.squeeze(data2['mean_qliq'][melt,:]),0)*1e3, color = 'orange', alpha = 0.15)
    ax.fill_betweenx(data1['height'],np.nanmedian(np.squeeze(data1['qliq'][melt,:]),0)*1e3 - np.nanstd(np.squeeze(data1['qliq'][melt,:]),0)*1e3,
        np.nanmedian(np.squeeze(data1['qliq'][melt,:]),0)*1e3 + np.nanstd(np.squeeze(data1['qliq'][melt,:]),0)*1e3, color = 'mediumaquamarine', alpha = 0.15)
    ...
    plt.plot(np.nanmedian(np.squeeze(data2['mean_qliq'][melt,:]),0)*1e3,data2['height'], color = 'darkorange', linewidth = 3, label = 'UM_CASIM-100_Swath')
    plt.plot(np.nanmedian(np.squeeze(data1['qliq'][melt,:]),0)*1e3,data1['height'], color = 'mediumseagreen', linewidth = 3, label = 'UM_CASIM-100_Point')
    # plt.xlabel('q$_{liq}$ [g kg$^{-1}$]')
    # ax.xaxis.set_label_position('top')
    # plt.ylabel('Z [km]')
    plt.ylim([0,9000])
    ...
    plt.subplot(233)
    ax = plt.gca()
    ax.fill_betweenx(data2['height'],np.nanmedian(np.squeeze(data2['mean_qice'][melt,:]),0)*1e3 - np.nanstd(np.squeeze(data2['mean_qice'][melt,:]),0)*1e3,
        np.nanmedian(np.squeeze(data2['mean_qice'][melt,:]),0)*1e3 + np.nanstd(np.squeeze(data2['mean_qice'][melt,:]),0)*1e3, color = 'orange', alpha = 0.15)
    ax.fill_betweenx(data1['height'],np.nanmedian(np.squeeze(data1['qice'][melt,:]),0)*1e3 - np.nanstd(np.squeeze(data1['qice'][melt,:]),0)*1e3,
        np.nanmedian(np.squeeze(data1['qice'][melt,:]),0)*1e3 + np.nanstd(np.squeeze(data1['qice'][melt,:]),0)*1e3, color = 'mediumaquamarine', alpha = 0.15)
    ...
    plt.plot(np.nanmedian(np.squeeze(data2['mean_qice'][melt,:]),0)*1e3,data2['height'], color = 'darkorange', linewidth = 3, label = 'UM_CASIM-100_Swath')
    plt.plot(np.nanmedian(np.squeeze(data1['qice'][melt,:]),0)*1e3,data1['height'], color = 'mediumseagreen', linewidth = 3, label = 'UM_CASIM-100_Point')
    # plt.xlabel('q$_{ice}$ [g kg$^{-1}$]')
    # ax.xaxis.set_label_position('top')
    # plt.ylabel('Z [km]')
    plt.ylim([0,9000])
    ...
    plt.subplot(234)
    ax = plt.gca()
    ax.fill_betweenx(data2['height'],np.nanmedian(np.squeeze(data2['mean_cloud_fraction'][freeze,:]),0) - np.nanstd(np.squeeze(data2['mean_cloud_fraction'][freeze,:]),0),
        np.nanmedian(np.squeeze(data2['mean_cloud_fraction'][freeze,:]),0) + np.nanstd(np.squeeze(data2['mean_cloud_fraction'][freeze,:]),0), color = 'orange', alpha = 0.15)
    ax.fill_betweenx(data1['height'],np.nanmedian(np.squeeze(data1['cloud_fraction'][freeze,:]),0) - np.nanstd(np.squeeze(data1['cloud_fraction'][freeze,:]),0),
        np.nanmedian(np.squeeze(data1['cloud_fraction'][freeze,:]),0) + np.nanstd(np.squeeze(data1['cloud_fraction'][freeze,:]),0), color = 'mediumaquamarine', alpha = 0.15)
    ...
    plt.plot(np.nanmedian(np.squeeze(data2['mean_cloud_fraction'][freeze,:]),0),data2['height'], color = 'darkorange', linewidth = 3, label = 'Swath')
    plt.plot(np.nanmedian(np.squeeze(data1['cloud_fraction'][freeze,:]),0),data1['height'], color = 'mediumseagreen', linewidth = 3, label = 'Point')
    plt.xlabel('C$_{V}$')
    # plt.legend()
    # ax.xaxis.set_label_position('top')
    plt.ylabel('Z [km]')
    ...
    plt.subplot(235)
    ax = plt.gca()
    ax.fill_betweenx(data2['height'],np.nanmedian(np.squeeze(data2['mean_qliq'][freeze,:]),0)*1e3 - np.nanstd(np.squeeze(data2['mean_qliq'][freeze,:]),0)*1e3,
        np.nanmedian(np.squeeze(data2['mean_qliq'][freeze,:]),0)*1e3 + np.nanstd(np.squeeze(data2['mean_qliq'][freeze,:]),0)*1e3, color = 'orange', alpha = 0.15)
    ax.fill_betweenx(data1['height'],np.nanmedian(np.squeeze(data1['qliq'][freeze,:]),0)*1e3 - np.nanstd(np.squeeze(data1['qliq'][freeze,:]),0)*1e3,
        np.nanmedian(np.squeeze(data1['qliq'][freeze,:]),0)*1e3 + np.nanstd(np.squeeze(data1['qliq'][freeze,:]),0)*1e3, color = 'mediumaquamarine', alpha = 0.15)
    ...
    plt.plot(np.nanmedian(np.squeeze(data2['mean_qliq'][freeze,:]),0)*1e3,data2['height'], color = 'darkorange', linewidth = 3, label = 'UM_CASIM-100_Swath')
    plt.plot(np.nanmedian(np.squeeze(data1['qliq'][freeze,:]),0)*1e3,data1['height'], color = 'mediumseagreen', linewidth = 3, label = 'UM_CASIM-100_Point')
    plt.xlabel('q$_{liq}$ [g kg$^{-1}$]')
    # ax.xaxis.set_label_position('top')
    # plt.ylabel('Z [km]')
    plt.ylim([0,9000])
    ...
    plt.subplot(236)
    ax = plt.gca()
    ax.fill_betweenx(data2['height'],np.nanmedian(np.squeeze(data2['mean_qice'][freeze,:]),0)*1e3 - np.nanstd(np.squeeze(data2['mean_qice'][freeze,:]),0)*1e3,
        np.nanmedian(np.squeeze(data2['mean_qice'][freeze,:]),0)*1e3 + np.nanstd(np.squeeze(data2['mean_qice'][freeze,:]),0)*1e3, color = 'orange', alpha = 0.15)
    ax.fill_betweenx(data1['height'],np.nanmedian(np.squeeze(data1['qice'][freeze,:]),0)*1e3 - np.nanstd(np.squeeze(data1['qice'][freeze,:]),0)*1e3,
        np.nanmedian(np.squeeze(data1['qice'][freeze,:]),0)*1e3 + np.nanstd(np.squeeze(data1['qice'][freeze,:]),0)*1e3, color = 'mediumaquamarine', alpha = 0.15)
    ...
    plt.plot(np.nanmedian(np.squeeze(data2['mean_qice'][freeze,:]),0)*1e3,data2['height'], color = 'darkorange', linewidth = 3, label = 'UM_CASIM-100_Swath')
    plt.plot(np.nanmedian(np.squeeze(data1['qice'][freeze,:]),0)*1e3,data1['height'], color = 'mediumseagreen', linewidth = 3, label = 'UM_CASIM-100_Point')
    plt.xlabel('q$_{ice}$ [g kg$^{-1}$]')
    # ax.xaxis.set_label_position('top')
    # plt.ylabel('Z [km]')
    plt.ylim([0,9000])
    ...
    fileout = '../FIGS/ACPD/Point_Vs_Swath_Melt-FreezeSplit_median.svg'
    plt.savefig(fileout, dpi=300)
    plt.show()
    # plt.close()
