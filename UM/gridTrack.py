...
def gridShipTrack(cube, xoffset, yoffset):
    ...
    ### box pick 22-23h
    lon = np.array([266,266,265,265,264,264,263])
    lat = np.array([385,384,384,383,383,382,382])
    tim = np.zeros([np.size(lon)])
    tim[:] = 22.0
    tim_149 = np.append(tim_149, tim)
    lat_149 = np.append(lat_149, lat)
    ...
    ### box pick 23-0h
    lon = np.array([263,263,263,262,262,262,261])
    lat = np.array([382,381,380,380,379,378,378])
    tim = np.zeros([np.size(lon)])
    tim[:] = 23.0
    tim_149 = np.append(tim_149, tim)
    lat_149 = np.append(lat_149, lat)
